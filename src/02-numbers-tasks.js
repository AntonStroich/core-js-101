...
function roundToPowerOfTen(num, pow) {
  /**
   * Divide the number by 10 raised to the power of `pow` to shift the decimal point.
   * Round the result to the nearest integer using Math.round.
   * Multiply by 10 raised to the power of `pow`
   * to shift the decimal point back to its original position.
  */
