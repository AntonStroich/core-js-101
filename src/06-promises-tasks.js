...
function chainPromises(array, action) {
  return array.reduce((accumulator, current) => accumulator
    .then((result) => current
      .then((value) => (result === undefined ? value : action(result, value))) // Combine values
      .catch(() => result)), // Ignore rejected promises
